...
class GeneticAlgorithm:
    ...
    def get_distance(self, starting_object, ending_object):
        ...
        search_obj.search_a_star()  # run A* algorithm to get journey cost
    ...
    @staticmethod
    def pick_mate(scores):  # pick two high (not always top) scorers
        ...
        for i in range(0, len(probabilities)):  # if score is higher (worse) -> more likely to cross
    ...
    def mutate(route, probability):
        ...
        if random.random() < probability:
            new_route[index_1], new_route[index_2] = new_route[index_2], new_route[index_1]  # swap two elements
    ...
    def run(self):
        ...
        number_of_winners_to_keep = WINNERS
        ...
        for i in range(0, number_of_iterations):
            ...
            new_population += [population[np.argmin(scores)]]  # keep best members of previous generation
            ...
            last_distance = distance  # best to keep
